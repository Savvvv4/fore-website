    ...
    >
      ...
      >
        ...
        {[320, 372, 424, 476, 528].map((tx, i) => (
          <circle key={i} cx={tx + 5} cy="456" r="2.5" fill="#70F250" opacity={0.5} />
        ))}
        ...
        <circle cx="131" cy="559" r="2.5" fill="#70F250" opacity={0.9} />
        <circle cx="149" cy="559" r="2.5" fill="#70F250" opacity={0.9} />
        ...
        <g filter="url(#eco-bldg-sh)">
          ...
          <path d="M 515 476 L 526 480 L 515 484 Z" fill="#70F250" />
        </g>
